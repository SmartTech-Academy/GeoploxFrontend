...
export const FavoriteButton: React.FC<FavoriteButtonProps> = ({
  ...
  const handleToggle = (event: React.MouseEvent) => {
    ...
    if (!user) {
      // In-place login modal, no navigation: keeps the user at their current scroll
      // position (list or detail page) instead of losing their spot on a /login redirect.
  ...
  return (
    <>
      ...
      <LoginDialog
        ...
        description="Log in to add this property to your favourites - you'll stay right where you are."
        onSuccess={() => {
