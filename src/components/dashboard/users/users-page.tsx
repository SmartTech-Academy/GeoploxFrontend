...
const OverviewMetric = ({ title, value, isLoading }: OverviewMetricProps) => (
              ...
              <div className="w-full border-t border-[#F1F1F4] pt-4">
                ...
                <div className="flex w-full flex-col gap-4 md:flex-row">
                  <div className="flex w-full flex-col gap-1.5">
                    <label className="text-[14px] leading-[17px] text-[#41415A]">
                      Proof of Address
                    </label>
            ...
            <div className="flex w-full flex-col items-start gap-5 py-8">
              ...
              <section className="grid grid-cols-1 gap-5 self-stretch md:grid-cols-2 lg:grid-cols-3">
                <OverviewMetric
                  ...
                  value={performanceTotals?.total_listings ?? 0}
                  isLoading={isLoadingPerformance}
                />
                <OverviewMetric
                  title="Active Listings"
                  value={performanceTotals?.active_listings ?? 0}
                  isLoading={isLoadingPerformance}
                />
                <OverviewMetric
                  title="Archived Listings"
                  value={performanceTotals?.archived_listings ?? 0}
                  isLoading={isLoadingPerformance}
                />
              </section>
