  ...
  return (
    <div className="flex w-full flex-col gap-10">
      <div className="flex flex-col items-center gap-3 self-stretch text-center">
        <h2 className="text-[28px] leading-[39px] font-semibold text-[#1F2130]">Security & Notifications</h2>
      ...
      <div className="flex w-full flex-col gap-8">
        <div className="flex flex-col items-start gap-5 self-stretch border-b border-[#F1F1F4] pb-8">
          ...
          <div className="box-border flex items-start justify-between gap-4 self-stretch rounded-[10px] border border-[#E3E3E8] bg-white px-5 py-6">
            <div className="flex grow flex-col items-start gap-2">
              <h3 className="text-[16px] leading-[16px] tracking-[-0.02em] text-[#282828]">Password</h3>

              <p className="text-[14px] leading-[20px] text-[#71748C]">Update your password</p>
            </div>
            <Button
              className="h-8 rounded-[32px] bg-[#F1F1F4] px-4 py-[15px] text-[14px] leading-[14px] font-normal text-black"
              variant="secondary"
              size="sm"
          ...
          <div className="box-border flex items-start justify-between gap-4 self-stretch rounded-[10px] border border-[#E3E3E8] bg-white px-5 py-6">
            <div className="flex grow flex-col items-start gap-2">
              <h3 className="text-[16px] leading-[16px] tracking-[-0.02em] text-[#282828]">Two-step authentication</h3>
        ...
        <div className="flex flex-col items-start justify-between gap-7 self-stretch rounded-[10px] border border-[#E3E3E8] bg-white px-5 py-6">
          <div className="flex w-full grow flex-col items-start gap-5">
            <h3 className="text-[16px] leading-[16px] font-normal tracking-[-0.02em] text-[#282828]">Notifications</h3>

            <div className="flex flex-col items-start gap-3 self-stretch">
              <div className="flex items-center justify-between gap-5 self-stretch border-b border-[#E3E3E8] pb-3">
                <span className="text-[14px] leading-[20px] text-[#71748C]">Would you like email notifications</span>
                <Switch
              ...
              <div className="flex items-center justify-between gap-5 self-stretch">
                <span className="text-[14px] leading-[20px] text-[#71748C]">Would you like in-app notifications</span>
                <Switch
