            ...
            <div className="flex w-full flex-col items-start gap-10 self-stretch">
              ...
              <div className="flex w-full flex-col gap-10">
                {properties.map((property) => (
                  <div
                    key={property.id}
                    className="flex w-full items-center justify-between gap-[89px] self-stretch border-b border-[#F1F1F4] pb-10"
                  >
                    <img src={property.images} alt="images" className="h-[266px] w-[463px]" width={463} height={266} />
