        ...
        <div className="max-h-80 overflow-y-auto">
          {isLoading ? (
            ...
            notifications.map((notification) => (
              <DropdownMenuItem
                key={notification.id}
                className={cn('flex items-start gap-3 p-2', !notification.read_at && 'bg-yellow-50/50')}
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  {!notification.read_at && <div className="size-2 self-end rounded-full bg-blue-500" />}
                  <Button
                    variant="ghost"
                    size="icon"
                    className="size-6 "
