      ...
      <section className="landing-container flex w-full flex-col gap-11 pt-[77px] pb-[33px]">
        <div className="flex flex-col items-center justify-between gap-12 lg:flex-row lg:gap-16">
          ...
          <div className="flex w-full max-w-[554px] flex-col items-start gap-12">
            <h1 className="text-[50px] leading-[60px] font-semibold tracking-[-0.02em] text-[#1F2130]">
              Get in Touch
            </h1>

            <p className="text-[20px]/7 text-[#4D5462]">
              If you would prefer to chat in real time with our support team, we are available
              online every week day.
            </p>
            ...
            <div className="flex flex-col items-start gap-[22px]">
              ...
              <div className="flex items-center gap-6">
                ...
                >
                  <TbBrandFacebook className="size-6 fill-primary text-primary" />
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <TbBrandTwitter className="size-6 fill-primary text-primary" />
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <TbBrandLinkedin className="size-6 fill-primary text-primary" />
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <TbBrandInstagram className="size-6 text-primary" />
                </a>
              </div>
            </div>
